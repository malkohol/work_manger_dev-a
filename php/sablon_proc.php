...
<i class="fa fa-bold" onclick="makeit('b');" ></i>
<i class="fa fa-italic" onclick="makeit('i');"></i>
<i class="fa fa-underline" onclick="makeit('u');"></i>
<i class="fa fa-align-left" onclick="makeit_aligment('left');"></i>
<i class="fa fa-align-center" onclick="makeit_aligment('center');"></i>
<i class="fa fa-align-right" onclick="makeit_aligment('right');"></i>
